      ...
      appBar: AppBar(
        ...
        title: requestAsync.when(
          ...
          data: (request) {
            return Column(
              ...
              children: [
                const Text('Müşteri ile Sohbet', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                Text(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => context.push('/driver/call/${widget.requestId}'),
          ),
                  ...
                  return const Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 12),
                        Text(
                          'Müşteriye ilk mesajınızı gönderin.',
