...
class DriverDisputesScreen extends ConsumerStatefulWidget {
  const DriverDisputesScreen({super.key});

  @override
  ConsumerState<DriverDisputesScreen> createState() => _DriverDisputesScreenState();
}

class _DriverDisputesScreenState extends ConsumerState<DriverDisputesScreen> {
