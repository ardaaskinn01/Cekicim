...
class DriverModel extends UserModel {
  ...
  factory DriverModel.fromJson(Map<String, dynamic> json, Map<String, dynamic> driverJson) {
    ...
    return DriverModel(
      ...
      driverLicenseUrl: driverJson.containsKey('driver_license_url') ? driverJson['driver_license_url'] as String? : null,
      srcCertificateUrl: driverJson.containsKey('src_certificate_url') ? driverJson['src_certificate_url'] as String? : null,
      psychotechnicUrl: driverJson.containsKey('psychotechnic_url') ? driverJson['psychotechnic_url'] as String? : null,
      vehicleRegistrationUrl: driverJson.containsKey('vehicle_registration_url') ? driverJson['vehicle_registration_url'] as String? : null,
      taxPlateUrl: driverJson.containsKey('tax_plate_url') ? driverJson['tax_plate_url'] as String? : null,
      criminalRecordUrl: driverJson.containsKey('criminal_record_url') ? driverJson['criminal_record_url'] as String? : null,
      vehiclePhotos: driverJson.containsKey('vehicle_photos') ? (driverJson['vehicle_photos'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [] : const [],
      equipments: driverJson.containsKey('equipments') ? (driverJson['equipments'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [] : const [],
      supportedVehicleTypes: driverJson.containsKey('supported_vehicle_types') ? (driverJson['supported_vehicle_types'] as List<dynamic>?)?.map((e) => e as String).toList() ?? const [] : const [],
      isOnboardingCompleted: driverJson.containsKey('is_onboarding_completed') 
          ? (driverJson['is_onboarding_completed'] as bool? ?? false)
          : ((driverJson['vehicle_plate'] as String? ?? '').isNotEmpty && (driverJson['iban'] as String? ?? '').isNotEmpty),
  ...
  Map<String, dynamic> toDriverJson() {
    return {
      ...
      // Verification document URLs, photos, equipments, and onboarding completed status are safely omitted from writing
      'iban': iban,
